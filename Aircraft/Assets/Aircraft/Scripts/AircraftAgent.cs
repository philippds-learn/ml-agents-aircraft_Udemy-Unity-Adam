...
namespace Aircraft
{
    public class AircraftAgent : Agent
    {
        ...
        // Wether the aircraft is frozen (intentionally not flying)
        ...
        public override void AgentAction(float[] vectorAction, string textAction)
        {
            ...
            // Read value for boost and enable/disable train renderer
        ...
        public override void CollectObservations()
        {
            ...
            AddVectorObs(rayPerception.Perceive(rayDistance: 250f,
        ...
        /// <summary>
        /// Resum agent movement and actions
        /// </summary>
        ...
        /// <param name="from">This is the lower limit</param>
        /// <param name="to">This is the upper limit</param>
        /// <returns></returns>
